...
document.querySelector("#deleteProfile").addEventListener("click",(e)=>{
    ...
    let text="Da li stvarno zelis da obrises?"
        ...
        document.querySelector("#allPostsWrapper").innerHTML=`<div class="single-post" data-post_id="${post.id}">
                                                                ...
                                                                <div class="post-actions">
                                                                    ...
                                                                    <div>
                                                                         ...
                                                                         <button class="coment-btn" onslick="commentPost(this)">Comments</button>
                                                                          ${delete_post_html}
                                                                    </div>
                                                                </div>
                                                                 ...
                                                                 <div class="post-comments">
                                                                     <form>
                                                                         <input placeholder="Napisi komentar...." type="text">
                                                                          <button class="rtt" onclick="commentPostSubmit(event)">Comment</button>
                                                                      </form>
                                                                     </div>
                                                                </div>
...
const commentPost=btn=>{
    let main_post_el=btn.closest(".single-post");
    let post_id=main_post_el.getAtribute('data-post_id');

    main_post_el.querySelector(".post_comments").style.display="block";
